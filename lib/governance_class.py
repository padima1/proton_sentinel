...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to protond "gobject list" output
    ...
    def protond_serialise(self):
        import protonlib
        return protonlib.SHIM_serialise_for_protond(self.serialise())
