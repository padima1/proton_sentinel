...
class ProtonDaemon():
    def __init__(self, **kwargs):
        ...
        # memoize calls to some protond methods
    ...
    @classmethod
    def from_proton_conf(self, proton_dot_conf):
        from proton_config import ProtonConfig
        config_text = ProtonConfig.slurp_config_file(proton_dot_conf)
    ...
    def get_my_gobject_votes(self, object_hash):
        ...
        if not self.gobject_votes.get(object_hash):
            ...
            self.gobject_votes[object_hash] = protonlib.parse_raw_votes(raw_votes)
    ...
    def we_are_the_winner(self):
        ...
        winner = protonlib.elect_mn(block_hash=current_block_hash, mnlist=mn_list)
        my_vin = self.get_current_masternode_vin()
    ...
    def estimate_block_time(self, height):
        ...
        future_seconds = protonlib.blocks_to_seconds(diff)
    ...
    def has_sentinel_ping(self):
        ...
        return (getinfo['protocolversion'] >= config.min_protond_proto_version_with_sentinel_ping)
